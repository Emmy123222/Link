  ...
  return (
    <div className="flex flex-col md:flex-row gap-8 mt-4 p-8 justify-start">
      ...
      <div className="flex-1 overflow-auto max-h-[80vh] max-w-3xl">
        {currentBusiness ? (<div className="bg-white rounded-lg shadow-sm p-6">
        ...
        </div>) : (<div className='flex justify-center items-center h-full'>Select your business to view customers</div>)}
      </div>
    </div>
  )
}
