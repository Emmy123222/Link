...
export function FilterPanel({ isOpen, onClose }: FilterPanelProps) {
  ...
  return (
    <div
      className="fixed inset-0 bg-black bg-opacity-30 z-50 flex justify-center items-start"
      onClick={(e) => {
    ...
    >
      <div
        ref={panelRef}
        className="bg-white w-full max-w-4xl mt-16 rounded-lg shadow-lg animate-slide-down overflow-hidden"
      >
        ...
        <div className="p-6">
          ...
          <div className="mt-6">
            ...
            <div className="relative">
              ...
              />
              <div
                className="absolute w-4 h-4 bg-green-500 rounded-full -mt-1 pointer-events-none"
