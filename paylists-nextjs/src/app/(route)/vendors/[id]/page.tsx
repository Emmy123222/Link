...
export default function MyBusinessPage() {
  ...
  const guestTabs = ["Additional data", "Business details"];
  ...
  // Check if current user can update this vendor profile
  // Only allow updates if vendor is not validated OR current user is the business owner
    ...
    <div className="flex flex-col md:flex-row gap-8 mt-4 p-8">
      ...
      <div className="flex-1 overflow-auto max-h-[80vh]">
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          {activeTab === "Business details" && <CustomerDetailInput business={business} setBusiness={setBusiness} editable={editable} />}
        </div>
      </div>
    </div>
  )
